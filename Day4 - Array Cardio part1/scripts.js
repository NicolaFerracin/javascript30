...
console.table(3, result);

// Array.prototype.reduce()
// 4. How many years did all the inventors live?
result = inventors.reduce((total, inventor) => total + inventor.passed - inventor.year, 0);
...
result = people.sort((a, b) => a.split(',').shift().trim() > b.split(',').shift().trim());
